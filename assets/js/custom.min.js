$(document).on("ready", function() {
  ...
  const targetDateThisYear = new Date(`${currentYear}-07-28T20:00:00`);
  const finalYear = (targetDateThisYear < today) ? currentYear + 1 : currentYear;

  $('.countdown').downCount({
    date: `07/28/${finalYear} 20:00:00`,
    offset: +10
  }, function () {
